...
class Valine extends Component {
    render() {
        ...
        return <Fragment>
            ...
            {!usePjax ? <div><script src="//cdn1.lncld.net/static/js/3.0.4/av-min.js"></script>
                <script src={jsUrl}></script></div> : null}
...
module.exports = cacheComponent(Valine, 'comment.valine', props => {
    const { comment, helper, page, use_pjax } = props;
    ...
    return {
        ...
        jsUrl: '//unpkg.com/valine@1.4.9/dist/Valine.min.js',
        path: "/" + page.path,
